IF NOT EXISTS (SELECT 1 FROM sys.databases WHERE name = 'LearningAppDB')
BEGIN
    -- Create the database
    CREATE DATABASE LearningAppDB;
END
ELSE
BEGIN
   DROP DATABASE LearningAppDB;
END
